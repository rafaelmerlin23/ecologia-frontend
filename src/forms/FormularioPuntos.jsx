...
export const FormularioPuntos = ({ location = {
    ...
    return (
        <Overlay animacion={closeLocationForm}>
            <form onSubmit={(e) => handle(e, name, longitude, latitude)} className=" p-5 xl:w-80 lg:w-80 md:w-80 ">
                <div className="mb-5">
